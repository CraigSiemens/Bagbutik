 ...
 */
public struct BetaTesterAppsLinkagesResponse: PagedResponse {
    ...
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/betatesterappslinkagesresponse/data>
     */
