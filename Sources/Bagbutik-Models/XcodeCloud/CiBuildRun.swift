 ...
 */
public struct CiBuildRun: Identifiable {
    ...
    public struct Attributes {
         ...
         */
        public struct DestinationCommit {
        ...
        public enum StartReason: String {
    ...
    public struct Relationships {
         ...
         */
        public struct DestinationBranch {
