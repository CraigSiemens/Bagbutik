...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/read_group_information_for_a_specific_group>
    ...
    {
        .init(path: "/v1/gameCenterGroups/\(id)", method: .get, parameters: .init(fields: fields,
                                                                                  includes: includes,
                                                                                  limits: limits))
    }
}
