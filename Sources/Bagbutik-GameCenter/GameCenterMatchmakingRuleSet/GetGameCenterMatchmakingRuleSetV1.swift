...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/read_rule_set_information>
...
public enum GetGameCenterMatchmakingRuleSetV1 {
    ...
    public enum Field: FieldParameter {
        ...
        public enum GameCenterMatchmakingRuleSets: String {
        ...
        public enum GameCenterMatchmakingRules: String {
            case description
            case expression
            case referenceName
            case ruleSet
        ...
        public enum GameCenterMatchmakingTeams: String {
            case maxPlayers
            case minPlayers
            case referenceName
            case ruleSet
