...
public extension Request {
    ...
    static func listPricePointsForAppPriceTierV1(id: String,
                                                 fields: [ListPricePointsForAppPriceTierV1.Field]? = nil,
                                                 filters: [ListPricePointsForAppPriceTierV1.Filter]? = nil,
                                                 includes: [ListPricePointsForAppPriceTierV1.Include]? = nil,
                                                 limit: Int? = nil) -> Request<AppPricePointsResponse, ErrorResponse>
    {
        .init(path: "/v1/appPriceTiers/\(id)/pricePoints", method: .get, parameters: .init(fields: fields,
                                                                                           filters: filters,
                                                                                           includes: includes,
                                                                                           limit: limit))
    }
...
public enum ListPricePointsForAppPriceTierV1 {
    /**
    ...
    public enum Field: FieldParameter {
        ...
        public enum AppPriceTiers: String, ParameterValue, CodableEnum, CaseIterable {
            case pricePoints
