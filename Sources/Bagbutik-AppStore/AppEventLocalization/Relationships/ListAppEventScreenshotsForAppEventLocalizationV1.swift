...
public extension Request {
    ...
    {
        .init(path: "/v1/appEventLocalizations/\(id)/appEventScreenshots", method: .get, parameters: .init(fields: fields,
                                                                                                           includes: includes,
                                                                                                           limit: limit))
    }
}
...
public enum ListAppEventScreenshotsForAppEventLocalizationV1 {
    ...
    public enum Field: FieldParameter {
        ...
        public enum AppEventLocalizations: String {
            case appEvent
        ...
        public enum AppEventScreenshots: String {
