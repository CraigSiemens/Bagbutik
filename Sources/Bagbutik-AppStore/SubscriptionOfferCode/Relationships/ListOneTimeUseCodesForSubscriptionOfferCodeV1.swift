...
public extension Request {
    ...
    {
        .init(path: "/v1/subscriptionOfferCodes/\(id)/oneTimeUseCodes", method: .get, parameters: .init(fields: fields,
                                                                                                        includes: includes,
                                                                                                        limit: limit))
    }
}
...
public enum ListOneTimeUseCodesForSubscriptionOfferCodeV1 {
    ...
    public enum Field: FieldParameter {
        ...
        public enum SubscriptionOfferCodeOneTimeUseCodes: String {
            case active
            case createdDate
            case expirationDate
            case numberOfCodes
